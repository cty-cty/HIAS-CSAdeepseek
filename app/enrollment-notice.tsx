      ...
      <div className="mt-3 grid gap-3 lg:grid-cols-2">
        <div className="rounded-2xl border border-slate-200 bg-white p-4">
          ...
          <ul className="mt-3 space-y-2 text-sm leading-6 text-slate-600">
            ...
            <li>
              学术型研究生（学硕/博士）可将本一级学科及其所属二级学科的课程作为学位课（本工具的「学位属性」会按所选培养方向提示可用范围）。
            </li>
            <li>
              专业型研究生（专硕）只能将本专业开设的专业课和核心课作为学位课；其他课程即使同为专业课，也不能作为学位课（可作非学位课或其他类别）。
            </li>
            <li>
            ...
            <li>跨学科、跨学院课程如需修读，须经导师和学院审核（外选课另见下方规则）。</li>
          </ul>
        </div>
